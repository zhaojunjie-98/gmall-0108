...
public class OssController {
    ...
    public ResponseVo<Object> policy(){
        String accessId = "LTAI5tKFHxuE3x3ocHUbtBrB"; // 请填写您的AccessKeyId。
        String accessKey = "ipgpaISvn0pDkT8rkX1WE7GoC86RLI"; // 请填写您的AccessKeySecret。
        String endpoint = "oss-cn-beijing.aliyuncs.com"; // 请填写您的 endpoint。
        String bucket = "glsc-gmall"; // 请填写您的 bucketname 。
